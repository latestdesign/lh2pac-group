...
This is the plaintext markup language used by [properdocs](https://properdocs.org/),
...
with no whitespace between the text and the asterisk.
...
```
    ...
    An expression can also be put in ***italics and bold***.
```    
...
```
    ...
    - Another item.
        ...
        * A sub-item (pay attention to the indentation: 2 spaces).
        * Another sub-item.

    - Another item
      written on two lines.

        1. A first sub-item (pay attention to the indentation: 2 spaces).
        2. A second sub-item.
```
...
Others are available [here](https://squidfunk.github.io/mkdocs-material/reference/admonitions/#supported-types).
...
GEMSEO[^1] is an open-source library for solving multidisciplinary problems.
