...
surrogate_discipline = SurrogateDiscipline("RandomForestRegressor", training_dataset)
...
print("result du CUSTOM", scenario_custom.optimization_result)
...
# %%
# Plot the optimization history:
scenario_custom.post_process(post_name="OptHistoryView", save=True, show=False)
...
#P1 
configuration_1 = AircraftConfiguration(area=119.910, n_pax = 120,slst = 100000, ar = 9.386 , name="Conf 1", color="b")
#draw_aircraft(configuration_1, title="Probleme 3 case 1")


configuration_2 = AircraftConfiguration(area=114.3872, n_pax = 120,slst = 100000, ar = 13.48155 , name="Conf 2", color="r")
#draw_aircraft(configuration_1, title="Probleme 3 case 2")
