...
"""scenario = UMDOScenario(
    ...
    statistic_estimation_settings=Surrogate_Settings(n_samples=50), #changer n_samples https://gemseo.gitlab.io/dev/gemseo-umdo/latest/user_guide/umdo/surrogate/
)   """
